...
class Movies
{
    ...
    /**
     * Renvoie la propriété $movies de la classe
     * Il renvoie TOUS les films
     */
    public static function getMovies()
    {
        // Etant donnée que la propriéte $movies est static, pour la récupérer il faut utiliser le mot clé self::
        return self::$movies;
    }
    ...
    {
        // pour verifier si quelque chose n'est pas définit, on utilise isset avec '!' juste avant isset (verifie si qqchose n'est pas définit)
